    ...
    <div className="App">
      <header className="App-header">
        ...
        <input
          ...
          onInput={e => onDecodeInputUpdated((e.target as HTMLInputElement).value)}
      ...
      <textarea
        ...
        onInput={e => onEncodeInputUpdated((e.target as HTMLInputElement).value)}
      ></textarea>
    </div>
  );
}
